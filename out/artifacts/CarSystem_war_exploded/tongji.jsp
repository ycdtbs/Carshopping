    ...
    <div class="container-fluid">
        ...
        <div class="widget-box">
            ...
            <div class="widget-content ">
                车辆受欢迎排行榜：
                <c:forEach items="${paimimnglist}" varStatus="index" var="flag">
                    <font size="10px" color="red">${flag.Carname}               </font>
                </c:forEach>
                目前总收益
                <c:forEach items="${money}" var="str" varStatus="index">
                    <font size="30px" color="red">${money}</font>
                </c:forEach>
