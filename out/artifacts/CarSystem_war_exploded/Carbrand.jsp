...
<script type="text/javascript">
    ...
    function del(id) {
        ...
        $.post("delCarbrandServlet",{"delid":newId},function (delresult) {
            alert("wojinrule");
...
<script type="text/javascript">
    ...
    function update(id) {
        ...
        var Carbrandkey =trcur.children().eq(1).html();//汽车编号名称
        var Carbrandname =trcur.children().eq(2).html();//汽车品牌名称
        var CarbrandAddress =trcur.children().eq(3).html();//汽车品牌产地
        $("#changeCarbrandkey").val(""+Carbrandkey);
        $("#changeCarbrandname").val(""+Carbrandname);
        $("#changeCarbrandaddress").val(""+CarbrandAddress);
    ...
    function updateimpl() {
        ...
        var Carbrandaddress=$("#changeCarbrandaddress").val();
        $.post("updateCarbrandServlet",{"Carbrandkey":Carbrandkey,"Carbrandname":Carbrandname,"Carbrandaddress":Carbrandaddress},function (updateresult) {
            if(updateresult.updatecarbrandresult>0){
                alert("我进入了修改界面");
                var a=$("#"+Carbrandkey).find("td").eq(1).html();
                $("#"+Carbrandkey).find("td").eq(1).html(""+Carbrandkey+"");//设置新的品牌id 但是不可修改
                $("#"+Carbrandkey).find("td").eq(2).html(""+Carbrandname+"");//设置新的平拍民
                $("#"+Carbrandkey).find("td").eq(3).html(""+Carbrandaddress+"");//设置新的产地
...
<script type="text/javascript">
    function addjump() {
        ...
        $("#changeCarbrandkey").blur(function () {
            ...
            $.post("CarbrandkeyServlet",{"Carbrandkey":Carbrandkey},function (Carbrandkeyresult) {
    ...
    function adduserimpl() {
        ...
        $.post("addCarbrandServlet",{"Carbrandkey":Carbrandkey,"Carbrandname":Carbrandname,"Carbrandaddress":Carbrandaddress},function (addcarresult) {
            if(addcarresult.addcarbrandresult>0){
                $("#showtable").append("<tr id=\""+Carbrandkey+"\">\n" +
                    "\n" +
                    "                                    <td>1</td>\n" +
                    "                                    <td>"+Carbrandkey+"</td>\n" +
                    "                                    <td>"+Carbrandname+"</td>\n" +
                    "                                    <td>"+Carbrandaddress+"</td>\n" +
                    "                                    <td>\n" +
                    "\n" +
                    "                                        <a href=\"#\" onclick=\"del("+Carbrandkey+")\"><font color=\"blue\">删除</font></a>\n" +
...
<script type="text/javascript">
    function selectbymohu() {
        var Carbrandkey = $("#selectCarbrandkey").val();
        var Carbrandname=$("#selectCarbrandname").val();
        var Carbrandaddress = $("#selectCarbrandaddress").val();
        window.location.href="showCarbrandServlet?Carbrandkey="+Carbrandkey+"&Carbrandname="+Carbrandname+"&Carbrandaddress="+Carbrandaddress+"";
            ...
            <div class="widget-box">
                    ...
                    <div class="widget-content ">
                        <table class="table table-bordered table-striped with-check"  id="showtable">
                            ...
                            <tr>
                                <td>查询</td>
                                <td><input type="text" class="span3 m-wrap" placeholder="请输入要查询的品牌编号" id="selectCarbrandkey" name="showusernumber" value=""></td>
                                <td><input type="text" class="span3 m-wrap" placeholder="请输入要查询的品牌名称" id="selectCarbrandname" name="showusername" value=""></td>
                                <td><input type="text" class="span3 m-wrap" placeholder="请输入要查询的产地" id="selectCarbrandaddress" name="userselect" value=""></td>
                                <td><input type="button" class="btn btn-info" value="查询" onclick="selectbymohu()"></td>
                            </tr>


                            <c:forEach items="${carbrandlist}" var="carlist" varStatus="str">


                                <tr id="${carlist.Brandkey}">

                                    <td>1</td>
                                    <td>${carlist.Brandkey}</td>
                                    <td>${carlist.Carbrand}</td>
                                    <td>${carlist.Adress}</td>
                                    <td>

                                        <a href="#" onclick="del(${carlist.Brandkey})"><font color="blue">删除</font></a>
